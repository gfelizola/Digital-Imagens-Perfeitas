...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td valign="top">
			...
			<form id="form-validate" action="acoes.asp?ac=video&id=<%=id%>" method="post">
			...
			<table align="left" cellpadding="5" width="100%" class="ui-widget-content ui-corner-all">
				<tbody>
					...
					<tr>
						<td>URL Youtube:</td>
						<td colspan="3"><input type="text" name="Arquivo" id="Arquivo" class="required text ui-widget-content ui-corner-all" title="O campo URL é obrigatório<br />" value="<%=Objeto.Item("Arquivo")%>" /></td>
					</tr>
