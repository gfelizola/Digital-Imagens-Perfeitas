...
OutL( "background:url('img/digital_bg.png') no-repeat center center black; background-size:100% 100%;" )
...
OutL( "}" )
'OutL( "#home .tags { background-image:url('img/tag_home.png'); }" )

OutL( "#contato.area {" )
OutL( "background: #84c2e3;" )
OutL( "}" )
...
For Each Cor In Lista.Items
	...
	OutL( "#" & Sig & " .tags { background-image:url('arquivos/Categorias_tag_" & Sig & ".png'); }" )
